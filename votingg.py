"""
Created on Thu Jul 23 14:40:20 2020
"""
import tkinter 
from tkinter import *
...
def about():
    messagebox.showinfo('About','Developed by vaidehi')
...
home['bg'] = '#49A'
Label(home,text='voting System',font='Helvetica 12 bold',bg='#49A').grid(row=1,column=2)
...
Label(home,text='OUR PROJECT',bg='#49A').grid(row=6,column=2)
Label(home,text='VOTING SYSTEM',bg='#49A').grid(row=7,column=2)
